...
const Modal_car_insurance = ({ isOpen, onClose }) => {
    ...
    >
      ...
      >
        <div className="d-flex align-items-center">
          ...
          <div>
            <div style={{ fontWeight: 700, fontSize: 18 }}>ข้อมูลรถ - ประกันภัยรถยนต์</div>
            <div style={{ fontSize: 12, opacity: 0.9 }}>สรุปสถานะประกันภัยรถยนต์</div>
          </div>
        </div>
...
export default Modal_car_insurance;
