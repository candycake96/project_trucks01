...
const Modal_UpdateAutoCar = ({isOpen, onClose, dataAuto}) => {
    ...
    const [formData, setFormData] = useState({
        ...
        useEffect(() => {
            if (dataAuto) {
                setFormData({
                    insurance_company: dataAuto.insurance_company || "",
                    loan_amount: dataAuto.loan_amount || "",
                    interest_rate: dataAuto.interest_rate || "",
                    monthly_payment: dataAuto.monthly_payment || "",
                    start_date: dataAuto.start_date ? dataAuto.start_date.split("T")[0] : "",
                    end_date: dataAuto.end_date ? dataAuto.end_date.split("T")[0] : ""
                })
            }
        }, [dataAuto])
...
export default Modal_UpdateAutoCar;