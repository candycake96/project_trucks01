...
async function generateRepairReport(data, resultRepuests, resultSystems) {
  try {
    ...
    const finalHtml = replaceAll(templateHtml, {
      ...
      company_logo: repairData.company_logo ?  `<img src="${process.env.BASE_URL}/api/company/imglogo/${repairData.company_logo}" alt="LogoCompany"/>` : ``,
      ...
      request_signature: repairData.request_signature  ? `<img src="${process.env.BASE_URL}/api/uploads/signature/${repairData.request_signature}" alt="ลายเซ็น"/>` : ``,
      planning_signature: repairData.planning_signature  ? `<img src="${process.env.BASE_URL}/api/uploads/signature/${repairData.planning_signature}" alt="ลายเซ็น"/>` : ``,
      analysis_signature: repairData.analysis_signature  ? `<img src="${process.env.BASE_URL}/api/uploads/signature/${repairData.analysis_signature}" alt="ลายเซ็น"/>` : ``,
      ana_approver_signature: repairData.ana_approver_signature  ? `<img src="${process.env.BASE_URL}/api/uploads/signature/${repairData.ana_approver_signature}" alt="ลายเซ็น"/>` : ``,
      request_approver: repairData.request_approver  ? `<img src="${process.env.BASE_URL}/api/uploads/signature/${repairData.request_approver}" alt="ลายเซ็น"/>` : ``,
